...
namespace BritishTime.Infrastructure.Migrations
{
    ...
    [Migration("20250504055752_CrmRecordAdded")]
    partial class CrmRecordAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BritishTime.Domain.Entities.CrmRecord", b =>
                {
                    ...
                    b.HasOne("BritishTime.Domain.Entities.AppUser", "DataProvider")
                        .WithMany()
                    ...
                    b.HasOne("BritishTime.Domain.Entities.AppUser", "SalesRepresentative")
                        .WithMany()
