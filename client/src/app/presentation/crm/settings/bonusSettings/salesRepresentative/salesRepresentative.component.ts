...
export class SalesRepresentativeComponent extends AppBaseComponent<IncentiveSettingModel, IncentiveSettingService> {
  participantType: ParticipantType = ParticipantType.SalesRepresentative;
  
  constructor(private fb: FormBuilder) {
    super(INCENTIVESETTING_SERVICE);
    this.pageTitle = 'Satış Temsilcisi Primlendirme Ayarı';
  }
  ...
  initForm(): void {
    this.pageForm = this.fb.group({
      id: [null],
      participantType: [ParticipantType.SalesRepresentative],
